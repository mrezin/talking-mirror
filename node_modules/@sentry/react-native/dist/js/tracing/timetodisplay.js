...
export function TimeToInitialDisplay(props) {
    ...
    return (React.createElement(TimeToDisplay, { initialDisplay: initialDisplay, parentSpanId: parentSpanId }, props.children));
}
/**
...
export function TimeToFullDisplay(props) {
    ...
    return (React.createElement(TimeToDisplay, { fullDisplay: fullDisplay, parentSpanId: parentSpanId }, props.children));
}
let nextCheckpointId = 0;
function useCoordinatedDisplay(kind, parentSpanId, props) {
    ...
    const registeredSpanRef = useRef(null);
...
function createTimeToDisplay({ useFocusEffect, Component, }) {
    const TimeToDisplayWrapper = (props) => {
        ...
        return React.createElement(Component, Object.assign({}, props, { record: gatedRecord, ready: gatedReady }));
    };
