...
export const reactNavigationIntegration = ({ routeChangeTimeoutMs = 1000, enableTimeToInitialDisplay = false, ignoreEmptyBackNavigationTransactions = true, enableTimeToInitialDisplayForPreloadedRoutes = false, useDispatchedActionData = false, useFullPathsForNavigationRoutes = false, enablePrefetchTracking = false, } = {}) => {
    ...
    const startIdleNavigationSpan = (unknownEvent, isAppRestart = false) => {
        ...
        const actionType = (_b = (_a = event === null || event === void 0 ? void 0 : event.data) === null || _a === void 0 ? void 0 : _a.action) === null || _b === void 0 ? void 0 : _b.type;
        const targetRouteName = getRouteNameFromAction(event);
        if (event && !isAppRestart && !((_c = event.data) === null || _c === void 0 ? void 0 : _c.noop)) {
            addBreadcrumb({
                category: 'navigation.dispatch',
                type: 'navigation',
                message: targetRouteName
                    ? `Dispatched ${actionType !== null && actionType !== void 0 ? actionType : 'NAVIGATE'} to ${targetRouteName}`
                    : `Dispatched ${actionType !== null && actionType !== void 0 ? actionType : 'NAVIGATE'}`,
                data: Object.assign(Object.assign({}, (actionType ? { action_type: actionType } : undefined)), (targetRouteName ? { to: targetRouteName } : undefined)),
                level: 'info',
            });
        }
        ...
        const spanName = (_d = finalSpanOptions.name) !== null && _d !== void 0 ? _d : DEFAULT_NAVIGATION_SPAN_NAME;
    ...
    const updateLatestNavigationSpanWithCurrentRoute = () => {
        ...
        let override;
        try {
            override = routeOverrideProvider === null || routeOverrideProvider === void 0 ? void 0 : routeOverrideProvider();
        }
        catch (e) {
            debug.warn(`${INTEGRATION_NAME} Route override provider threw, falling back to React Navigation route.`, e);
        }
        if (override === null || override === void 0 ? void 0 : override.templatedPath) {
            routeName = override.templatedPath;
            routePath = override.templatedPath;
            routeUrl = override.concreteUrl;
            routeParams = (_a = override.params) !== null && _a !== void 0 ? _a : route.params;
        }
        ...
        const sendDefaultPii = (_d = (_c = (_b = getClient()) === null || _b === void 0 ? void 0 : _b.getOptions()) === null || _c === void 0 ? void 0 : _c.sendDefaultPii) !== null && _d !== void 0 ? _d : false;
        ...
        pushRecentRouteKey(route.key);
        if ((override === null || override === void 0 ? void 0 : override.templatedPath) || useFullPathsForNavigationRoutes) {
    ...
    const _setRouteOverrideProvider = (provider) => {
